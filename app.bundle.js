...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "weather_app_odin:";
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkweather_app_odin"] = self["webpackChunkweather_app_odin"] || [];
...
__webpack_require__.d(__webpack_exports__, {
  G: () => (/* binding */ getDailyDataAndIcon),
  p: () => (/* binding */ getDataAndIcon)
});
...
const src_button = document.querySelector("#search");
...
async function getDataAndIcon() {
  ...
  const icon = await __webpack_require__(644)(`./${currIcon}.png`);
...
async function getDailyDataAndIcon() {
  ...
  for (let i = 0; i < data.length; i++) {
    ...
    const icon = await __webpack_require__(644)(`./${data[i].icon}.png`);
    const iconSrc = icon.default;
